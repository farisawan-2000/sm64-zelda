	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ANIMATED_PART(1, -3055, 774, 3055, bob_Cylinder_mesh),
				GEO_ANIMATED_PART(1, 3061, 774, 3055, bob_Cylinder_001_mesh),
				GEO_ANIMATED_PART(1, -2552, 344, 6286, bob_Cylinder_002_mesh),
				GEO_ANIMATED_PART(1, 2637, 344, 6286, bob_Cylinder_003_mesh),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
